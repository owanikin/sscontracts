...
contract SimpleAuction {
    ...
    // The triple-slash commens are so-called natspec comments. 
    ...
    function bid() external payable {
        ...
        // information is already part of the transaction.
        // The keyword payable is required ofr the function to be able to receive ether
    ...
    function withdraw() external returns (bool) {
        ...
        if (amount > 0) {
            // It is important to set this to zero because the recipeient
            // can call this function again as part of the recieving call
            // before 'send' returns.
    ...
    function auctionEnd() external {
        ...
        // with other contracts (i.e they call functions or send Ether) into three phases.
        // 1. checking conditions
        // 2. performing actions (potentially changing conditions)
        // 3. interacting with other contracts
        // If these phases are mixed up, the other contract could call
        // back into the current contract and modify the state or cause effects (ether payout) to
